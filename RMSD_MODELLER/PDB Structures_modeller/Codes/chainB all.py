...
aligned_output = os.path.join(output_folder, "COX2_All_Mutations_model2_aligned.pdb")

rmsd_output = os.path.join(output_folder, "COX2_All_Mutations_model2_RMSD.txt")
...
with open(rmsd_output, "w") as f:
    f.write(f"RMSD between 5IKQ_B template and COX2_All_Mutations.B99990002 model: {rmsd_value:.3f} Å")
