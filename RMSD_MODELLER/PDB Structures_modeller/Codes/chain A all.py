...
model_file = r"D:\RMSD_MODELLER\PDB Structures_modeller\Inputs\COX2_All_Mutations.B99990005.pdb"

output_folder = r"D:\RMSD_MODELLER\PDB Structures_modeller\Outputs"

aligned_output = os.path.join(output_folder, "COX2_All_Mutations_aligned.pdb")

rmsd_output = os.path.join(output_folder, "COX2_All_Mutations_RMSD.txt")
...
with open(rmsd_output, "w") as f:
    f.write(f"RMSD between Template and COX2_All_Mutations Model: {rmsd_value:.3f} Å")

print("RMSD Calculation Completed")
print("RMSD =", round(rmsd_value,3), "Å")

print("Aligned model saved at:", aligned_output)
